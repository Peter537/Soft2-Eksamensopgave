# **Testplan for MToGo's Agent Service**
...
**AgentService** håndterer administration af agents på **MToGo** platformen, inklusive oprettelse, opdatering og sletning af agentkonti, og status aktivering/deaktivering.

Projektet skal:

- Validere at AgentServicen korrekt processer og persisterer data.
- Verificere at AgentServicen outputter korrekt data.
...
- **Integrationstests**: Samspil mellem AgentServicen og databasen.
- **Acceptance Tests**: Tester API'er.
