# **Testplan for MToGo's Partner Service**
...
- Validere at PartnerServicen korrekt processer og persisterer data.
- Verificere at PartnerServicen outputter korrekt data.
...
- **Integrationstests**: Samspil mellem PartnerServicen og databasen.
