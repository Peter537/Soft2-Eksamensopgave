...
- [agent-bonus-service-test-plan.md](agent-bonus-service-test-plan.md) *(har egne integrationstests)*
...
*Dette dokument opdateres løbende baseret på projektets progression og erfaringer.*
