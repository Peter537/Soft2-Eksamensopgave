...
- **409 Conflict**: Bruges for konflikter, f.eks. forsøg på to agents at acceptere samme ordre.
...
Lytter på WebSocket events: OrderAccepted, OrderReady, AgentAssigned
...
| :------------------------------------------ | :----------------------------------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| /orders/order (POST)                        | Opret ny ordre                                               | {<br>&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>} | 201<br><br>{<br>&nbsp;&nbsp;"id": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| /orders/order/{id}/accept (POST)            | Partner acceptere en ordre                                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 204                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /orders/order/{id}/reject (POST)            | Partner afviser en ordre                                     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 204                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /orders/order/{id}/assign-agent (POST)      | Agent har taget en ordre-request                             | {<br>&nbsp;&nbsp;"agentId": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | 204                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /orders/order/{id}/set-ready (POST)         | Partner er færdig med ordre                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 204                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /orders/order/{id}/pickup (POST)            | Agent afhenter en ordre                                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 204                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /orders/order/{id}/complete-delivery (POST) | Agent har afleveret ordre                                    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 204                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| /orders/order/{id} (GET)                    | Tjek order information                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 200<br><br>{<br>&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;"agentId": "integer",<br>&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| /orders/customer/{id} (GET)                 | Hent alle orders fra en customer                             | (optional)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                            | 200<br><br>{<br>&nbsp;&nbsp;"array": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"agentId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>}    |
| /orders/partner/{id} (GET)                  | Hent alle orders fra en partner                              | (optional)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                            | 200<br><br>{<br>&nbsp;&nbsp;"array": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"agentId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>}   |
| /orders/agent/{id} (GET)                    | Hent alle orders fra en agent                                | (optional)<br> {<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                           | 200<br><br>{<br>&nbsp;&nbsp;"array": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>} |
| /orders/customer/{id}/active (GET)          | Hent aktive orders fra en customer (ikke Delivered/Rejected) |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 200<br><br>{<br>&nbsp;&nbsp;"array": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"agentId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>}    |
| /orders/partner/{id}/active (GET)           | Hent aktive orders fra en partner (ikke Delivered/Rejected)  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 200<br><br>{<br>&nbsp;&nbsp;"array": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"agentId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>}   |
| /orders/agent/{id}/active (GET)             | Hent aktive orders fra en agent (ikke Delivered/Rejected)    |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | 200<br><br>{<br>&nbsp;&nbsp;"array": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"serviceFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"status": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"foodItemId": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"unitPrice": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;]<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>} |

### Events Published

| Event               | Required Schema                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| :------------------ | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| OrderCreatedEvent   | {<br>&nbsp;&nbsp;"orderId": "integer",<br>&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;"orderCreatedTime": "string",<br>&nbsp;&nbsp;"distance": "string",<br>&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer"<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>}                                                                                                                                                                                                                  |
| OrderAcceptedEvent  | {<br>&nbsp;&nbsp;"orderId": "integer",<br>&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;"partnerName": "string",<br>&nbsp;&nbsp;"partnerAddress": "string",<br>&nbsp;&nbsp;"deliveryAddress": "string",<br>&nbsp;&nbsp;"deliveryFee": "decimal",<br>&nbsp;&nbsp;"distance": "string",<br>&nbsp;&nbsp;"estimatedMinutes": "integer",<br>&nbsp;&nbsp;"timestamp": "string",<br>&nbsp;&nbsp;"items": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"quantity": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>} |
...
Alle endpoints starter med /api/v1/partners/

| Endpoint (Method)                      | Description                 | Request body                                                                                                                                                                                                                                                                                                                                                              | Response schema                                                                                                                                                                                                                           |
| :------------------------------------- | :-------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| / (POST)                               | Nyoprettet partner          | {<br>&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;"address": "string",<br>&nbsp;&nbsp;"email": "string",<br>&nbsp;&nbsp;"password": "string",<br>&nbsp;&nbsp;"menu": [<br>&nbsp;&nbsp;&nbsp;&nbsp;{<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"price": "decimal"<br>&nbsp;&nbsp;&nbsp;&nbsp;}<br>&nbsp;&nbsp;]<br>} | 201<br><br>{<br>&nbsp;&nbsp;"id": "integer"<br>}                                                                                                                                                                                          |
| /login (POST)                          | Log ind en partner          | {<br>&nbsp;&nbsp;"email": "string",<br>&nbsp;&nbsp;"password": "string"<br>}                                                                                                                                                                                                                                                                                              | 200<br><br>{<br>&nbsp;&nbsp;"jwt": "string"<br>}                                                                                                                                                                                          |
| / (GET)                                | Hent alle aktive partnere   | (optional query params)<br>{<br>&nbsp;&nbsp;"offset": "integer",<br>&nbsp;&nbsp;"limit": "integer"<br>}                                                                                                                                                                                                                                                                   | 200                                                                                                                                                                                                                                       |
| /{id} (GET)                            | Hent information om Partner |                                                                                                                                                                                                                                                                                                                                                                           | 200<br><br>{<br>&nbsp;&nbsp;"id": "integer",<br>&nbsp;&nbsp;"name": "string",<br>&nbsp;&nbsp;"address": "string"<br>}                                                                                                                     |
...
| /{id}/active (PATCH)                   | Toggle partner availability | {<br>&nbsp;&nbsp;"active": "boolean"<br>}                                                                                                                                                                                                                                                                                                                                 | 204                                                                                                                                                                                                                                       |
...
Alle endpoints starter med /api/v1/feedback-hub/reviews/

| Endpoint (Method)             | Description                             | Request body                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Response schema                                      |
| :---------------------------- | :-------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------- |
| / (POST)                      | Opret nyt review                        | {<br>&nbsp;&nbsp;"orderId": "integer",<br>&nbsp;&nbsp;"agentId": "integer",<br>&nbsp;&nbsp;"partnerId": "integer",<br>&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;"timestamp": "string",<br>&nbsp;&nbsp;"ratings": {<br>&nbsp;&nbsp;&nbsp;&nbsp;"food": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;"agent": "integer",<br>&nbsp;&nbsp;&nbsp;&nbsp;"order": "integer"<br>&nbsp;&nbsp;},<br>&nbsp;&nbsp;"comments": {<br>&nbsp;&nbsp;&nbsp;&nbsp;"food": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;"agent": "string",<br>&nbsp;&nbsp;&nbsp;&nbsp;"order": "string"<br>&nbsp;&nbsp;}<br>} | 201                                                  |
| /order/{orderId} (GET)        | Hent ordre review på en ordre           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 200                                                  |
| /order/{orderId}/exists (GET) | Tjek om review eksisterer for en ordre  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 200<br><br>{<br>&nbsp;&nbsp;"exists": "boolean"<br>} |
| /orders (GET)                 | Hent alle ordre reviews                 | (optional query params)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                       | 200                                                  |
| /orders/{orderId} (GET)       | Hent ordre review på en ordre           |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 200                                                  |
| /agents/{agentId} (GET)       | Hent alle ordre reviews for en agent    | (optional query params)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                       | 200                                                  |
| /customers/{customerId} (GET) | Hent alle ordre reviews for en customer | (optional query params)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                       | 200                                                  |
| /partners/{partnerId} (GET)   | Hent alle ordre reviews for en partner  | (optional query params)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string",<br>&nbsp;&nbsp;"amount": "integer"<br>}                                                                                                                                                                                                                                                                                                                                                                                                                                       | 200                                                  |
...
Alle endpoints starter med /api/v1/customers/
...
| /delete/{id} (DELETE) | Delete customer             |                                                                                                                                                                                                                                                 | 204                                                                                                                                          |
...
Alle endpoints starter med /api/v1/agents/
...
Alle endpoints starter med /api/v1/agent-bonus/

| Endpoint (Method)        | Description                        | Request body                                                                                      | Response schema                                     |
| :----------------------- | :--------------------------------- | :------------------------------------------------------------------------------------------------ | :-------------------------------------------------- |
| /{agentId} (GET)         | Hent en bonus for en agent         | (query params)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string"<br>} | 200<br><br>{<br>&nbsp;&nbsp;"bonus": "decimal"<br>} |
| /{agentId}/preview (GET) | Hent en bonus preview for en agent | (query params)<br>{<br>&nbsp;&nbsp;"startDate": "string",<br>&nbsp;&nbsp;"endDate": "string"<br>} | 200                                                 |
| /health (GET)            | Health check                       |                                                                                                   | 200<br><br>{<br>&nbsp;&nbsp;"status": "string"<br>} |
...
| Endpoint (Method)                   | Description       | Request body                                                                      | Response schema |
| :---------------------------------- | :---------------- | :-------------------------------------------------------------------------------- | :-------------- |
| /api/v1/notifications/notify (POST) | Send notifikation | {<br>&nbsp;&nbsp;"customerId": "integer",<br>&nbsp;&nbsp;"message": "string"<br>} | 202             |
...
Lytter på Kafka Events: OrderAccepted, AgentAssigned, OrderReady
